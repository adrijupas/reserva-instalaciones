<?php
/*Este archivo es parte de reservadepistasdeportivas, wp-bootstrap-starter child theme.
...
if ( ! function_exists( 'suffice_child_enqueue_child_styles' ) ) {
	function reservadepistasdeportivas_enqueue_child_styles() {
...
add_action( 'wp_enqueue_scripts', 'reservadepistasdeportivas_enqueue_child_styles' );
